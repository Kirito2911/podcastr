...
export function Player(){
   ...
   const {clearPlayerState ,isShuffling, toggleShuffle, toggleLoop, isLooping ,hasNext, hasPrevious, playNext, playPrevious, episodeList, currentEpisodeIndex, isPlaying, togglePlay, setPlayingState} = useContext(PlayerContext);
